            ...
            <x-tabs.tab-panel>
                <div>
                    <x-slot name="tabs">
                        ...
                        <x-tabs.tab>
                            <div class="text-lg inline-flex items-center gap-x-3 dark:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     version="1.1" id="Layer_1" width="24px" class="text-white bg-white" height="24px"
                ...
                <x-slot name="content">
                    ...
                    <div class="w-full flex flex-col">
                        <div class="w-full flex justify-between items-center p-5 border-b">
                            ...
                            <div>
{{--                                <button type="button" class="ti-btn ti-btn-outline-primary !rounded-full btn-wave ">Add New</button>--}}
                                <button type="button" class="ti-btn ti-btn-primary-gradient !rounded-full btn-wave ">Add Account</button>
                            </div>
                        </div>
                        <div>
                            <x-tabs.content>
                                                        ...
                                                        <tr class="crm-contact companies-list border-b !border-defaultborder dark:!border-defaultborder/10">
                                                            ...
                                                            <td>
                                                                <div class="flex items-center gap-2">
                                                                    ...
                                                                    <div>
                                                                        <a data-bs-toggle="offcanvas" data-hs-overlay="#offcanvasExample">Dlab Solutions</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="text-center">
                                                        ...
                                                        <tr class="crm-contact companies-list border-b !border-defaultborder dark:!border-defaultborder/10">
                                                            ...
                                                            <td>
                                                                <div class="flex items-center gap-2">
                                                                    ...
                                                                    <div>
                                                                        <a data-bs-toggle="offcanvas" data-hs-overlay="#offcanvasExample">Meta Solutions</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="text-center">

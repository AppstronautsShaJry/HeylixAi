@props([
    'message' => 'The Icon is popover',
    'popover' => 'click',
    'size' => 'size-5'
])

<div class="hs-tooltip ti-main-tooltip [--trigger:{{$popover}}] [--placement:top]">
    <a class="hs-tooltip-toggle ti-main-tooltip-toggle" href="javascript:void(0);">
        <svg xmlns="http://www.w3.org/2000/svg" class="{{$size}} fill-primary mb-2"

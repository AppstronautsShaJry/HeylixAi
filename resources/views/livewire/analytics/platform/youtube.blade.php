...
<div class="main-content app-content">
    ...
    <div x-data="tableData()">
        ...
        <div class="fixed -right-3 bottom-20 z-30 border border-danger/50 rounded-sm flex justify-end gap-2 mr-8" id="files-main-nav">
                        ...
                        <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                            <template x-for="(column, index) in columns" :key="index">
                                <td x-show="column.visible">
                                    ...
                                    <template x-if="column.name === 'Watch Time'">
                                        <span class="badge bg-primary/10 text-primary" x-text="row.watchtime"></span>
                                    </template>
                                    <template x-if="column.name === 'Subscribers'">
                                        <div class="avatar-list-stacked inline-flex items-center gap-x-1">
                                            ...
                                            <a class="avatar avatar-sm bg-primary text-white avatar-rounded"
                                               href="javascript:void(0);" x-text="row.subcribers"></a>
                                        </div>
                                    </template>
                                    <template x-if="column.name === 'Impression CTR'"><span
                                            x-text="row.impressionctr"></span>
                                    </template>
            ...
            document.addEventListener("alpine:init", () => {
                Alpine.data("tableData", () => ({
                    columns: [
                        ...
                        {name: "Watch Time", visible: true},
                        {name: "Subscribers", visible: true},
                        {name: "Impression CTR", visible: true}
                    ],
                    rows: [
                        {
                            postName: "Blog Post",

...
<div class="main-content app-content">
        ...
        <div class="table-responsive">
            <table class="table whitespace-nowrap min-w-full">
                ...
                <tr class="border-b  border-defaultborder dark:border-defaultborder/10">
                    <th scope="col" class="text-start">Post Name</th>
                    <th scope="col" class="text-start">Type</th>
                    <th scope="col" class="text-start">Date</th>
                    <th scope="col" class="text-start">Content</th>
                    <th scope="col" class="text-start">Average Watch Time</th>
                    <th scope="col" class="text-start">Impression</th>
                    <th scope="col" class="text-start">Reach</th>
                    ...
                    <th scope="col" class="text-start">Link Click</th>
                </tr>
                </thead>
                <tbody>
                @for($i=0; $i<=5; $i++)
                    <tr class="border-b  border-defaultborder dark:border-defaultborder/10">
                        ...
                        <td>
                            <div class="flex items-center">
                                {{\Illuminate\Support\Str::words(' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure!', 4)}}
                            </div>
                        </td>
                        <td>
                            <div class="flex items-center">
                        ...
                        <td><span class="badge bg-primary/10 text-primary">20%</span></td>
                        <td>
    ...
    <div class="w-full box ">
        <div x-data="tableManager()" class="p-4">
            <!-- Column Toggle Controls -->
            <div class="mb-4 flex gap-4 flex-wrap">
                <template x-for="(column, index) in columns" :key="index">
                    <label class="inline-flex items-center space-x-2">
                        <input type="checkbox" x-model="column.visible" class="form-checkbox text-blue-600"/>
            ...
            <div class="table-responsive">
                <table class="table whitespace-nowrap min-w-full">
                    ...
                    <tr class="border-b  border-defaultborder dark:border-defaultborder/10">
                        <template x-for="(column, index) in columns" :key="index">
                            <th x-show="column.visible" scope="col" class="">
                                <span x-text="column.name"></span>
                            </th>
                        </template>
                    </tr>
                    ...
                    <tr class="border-b  border-defaultborder dark:border-defaultborder/10">
                        <template x-for="(column, index) in columns" :key="index">
                            <td x-show="column.visible" class="">Sample Data</td>
                        </template>
                    </tr>
                    <tr class="border-b">
                        <template x-for="(column, index) in columns" :key="index">
                            <td x-show="column.visible" class="">Sample Data 2</td>
                        </template>
                    </tr>
                    </tbody>
                </table>

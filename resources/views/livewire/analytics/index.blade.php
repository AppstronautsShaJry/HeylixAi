                        ...
                        <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                            <template x-for="(column, index) in columns" :key="index">
                                <td x-show="column.visible">
                                    ...
                                    <template x-if="column.name === 'Content'"><span x-text="row.content"></span>
                                    </template>
                                    <template x-if="column.name === 'Average Watch Time'"><span
                                            x-text="row.watchTime"></span></template>
                                    ...
                                    <template x-if="column.name === 'Shares'">
                                        <div class="avatar-list-stacked inline-flex items-center gap-x-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                 fill="currentColor" class="size-4">
                                                <path
                                            ...
                                            <a class="avatar avatar-sm bg-primary text-white avatar-rounded"
                                               href="javascript:void(0);" x-text="row.shares"></a>
                                        </div>
                                    </template>
                                    <template x-if="column.name === 'Link Click'"><span x-text="row.linkClick"></span>
                                    </template>
                                </td>
                            </template>
                        </tr>

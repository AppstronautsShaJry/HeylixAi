        ...
        <div class="grid grid-cols-12 sm:gap-x-6">
            <div class=" xl:col-span-9 col-span-12 ">
                ...
                <div class="xl:col-span-9 col-span-12 flex gap-5">
                    <div class="box w-6/12 h-[27rem]">
                        <div class="box-header w-full flex justify-between">
                            <div class="box-title">AD Balance</div>
                            <div>

                                <button type="button"
                                        class="hs-dropdown-toggle ti-btn btn-wave ti-btn-primary max-w-max text-xs"
                        ...
                        <div class="box-body relative w-full">
                            ...
                            <div class="absolute bottom-7 space-y-2 w-full">
                                ...
                                <button type="button"
                                        class="hs-dropdown-toggle ti-btn w-10/12 py-2btn-wave ti-btn-primary"
                                        data-hs-overlay="#exampleModalScrollable4">Add Amount
                                </button>

                                <div id="exampleModalScrollable4" class="hs-overlay ti-modal w-full">
                                    <div
                                        class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                        <div class="ti-modal-content w-4/12 mx-auto">
                                            <div class="ti-modal-header">
                                                <h6 class="modal-title text-[1rem] font-semibold"
                                                    id="staticBackdropLabel4">Add Balance
                                                </h6>
                                                <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                            ...
                                            <div class="ti-modal-body">
                                                <div class="container-fluid">
                                                    <div class=" p-4 flex flex-col gap-5">
                                                        ...
                                                        <div
                                                            class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 gap- flex flex-col w-full">
                                                            <label for="input-rounded1"
                                                                   class="ti-form-label">Amount</label>
                                                            <input type="text" class="form-control" id="input-rounded1"
                                                                   placeholder="0">
                                                        </div>

                                                        <div
                                                            class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 flex flex-col gap-3 ">
                                                            <label class="rounded-sm !p-0 font-medium">Payment
                                                                By</label>
                                                        ...
                                                        <div class="flex justify-end w-full">
                                                            <button class="ti-btn ti-btn-primary w-24 h-8">Pay Now
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>

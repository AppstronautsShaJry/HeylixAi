...
<div class="main-content app-content px-5 space-y-5">
    <div class="container-fluid">
        ...
        <div class="grid grid-cols-12 gap-x-6">
            ...
            <div class="xl:col-span-8 col-span-12">
                <form class="p-4 grid grid-cols-12 gap-4 box">
                    ...
                    <div class="col-span-12 ">
                        <span class="text-lg font-semibold">Lead Generation - Youtube</span>
            ...
            <div class="xl:col-span-4 col-span-12  dark:bg-bodybg bg-white rounded-lg h-[45rem] px-3">
                ...
                <span class="flex text-lg font-bold px-3 py-2">
                    Add Assets
                        ...
                        <button type="button"
                                class="hs-dropdown-toggle ti-btn py-2 btn-wave ti-btn-primary"
                    ...
                    <div class="col-span-12 lg:col-span-12 my-5">
                        <div class="flex flex-col px-4">
                            <div class="flex flex-row gap-1">
                                <div class="text-lg font-medium">Videos</div>
                                <div class="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                                    <a class="hs-tooltip-toggle ti-main-tooltip-toggle" href="javascript:void(0);">
                            ...
                            <div class="text-md">Add upto 5 videos</div>
                        </div>

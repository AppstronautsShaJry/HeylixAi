                                                    ...
                                                    <div
                                                        ...
                                                        <div class="ti-modal-content w-full">
                                                            ...
                                                            <div class="ti-modal-body w-full">
                                                                <div x-cloak x-data="{ tabs: 'tabs1' }"
                                                                     class="flex w-full gap-5 h-60">
                                                                    <div class="w-2/5 h-full flex flex-wrap gap-5">
                                                                        <div
                                                                            class="w-28 h-28 flex justify-center items-center border border-info rounded-md">
                                                                            <button @click="tabs = 'tabs1'"
                                                                                    type="button"
                                                                                    aria-label="button"
                                                                        ...
                                                                        <div x-cloak x-show="tabs === 'tabs2'"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <textarea
                                                                                    class="form-control w-full h-full"
                                                                                    id="nft-description" rows="3"
                                                                                    placeholder="Generate Caption for your Instagram Post"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div x-cloak x-show="tabs === 'tabs3'"
                                                                             class="h-full">
                                                                            <div
                                                                                class="xl:col-span-12 col-span-12 h-[80%]">
                                                                                <label for="nft-description"
                                                                                ...
                                                                                <textarea
                                                                                    class="form-control w-full h-full"
                                                                                    id="nft-description" rows="3"
                                                                                    placeholder="Generate Caption for your Twitter Post"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div x-cloak x-show="tabs === 'tabs4'"
                                                                             class="h-full">
                                                                            <div
                                                                                class="xl:col-span-12 col-span-12 h-[80%]">
                                                                                <label for="nft-description"
                                                                                ...
                                                                                <textarea
                                                                                    class="form-control w-full h-full"
                                                                                    id="nft-description" rows="3"
                                                                                    placeholder="Generate Caption for your LinkedIn Post"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="ti-btn-group !p-0 !border-0 !m-0">
                                                    ...
                                                    <span>
                                                        ...
                                                        <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                                            ...
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Food</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Business</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Home</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Finance</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Travel</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Technology</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Health</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Education</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Entertainment</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Sports</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Shopping</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Fashion</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Real Estate</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Automotive</a></li>
                                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Lifestyle</a></li>

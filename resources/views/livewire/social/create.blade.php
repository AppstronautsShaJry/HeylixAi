                                        ...
                                        <div class="flex justify-between items-center py-3">
                                            ...
                                            <div class="flex items-center justify-between">
                                                <button @click="toggleListening"
                                                        :class="isListening ? 'border border-red-500' : 'border border-info'"
                                                        class="rounded-sm p-3 font-medium text-white flex item-center gap-x-2  transition-all duration-300">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="" height=""
                                                         fill="currentColor" class="w-4 h-4 text-info"
                                                         :class="isListening ? 'text-red-500' : 'text-info'"
                                                         viewBox="0 0 16 16">
                                                        <path
                                                    ...
                                                    <span
                                                        x-text="isListening ? 'Stop Voice Typing' : 'Start Voice Typing'"
                                                ...
                                                <span x-show="isListening"
                                                      class="text-red-500 font-semibold animate-pulse">
                                                Listening...
                                            </span>
                                            </div>

    ...
    <div class="container-fluid">
        ...
        <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
            <div>
                <ol class="breadcrumb mb-0">
                    ...
                    {{--                        </a>--}}
                    {{--                    </li>--}}
                    <li class="breadcrumb-item active" aria-current="page"><a href="/calender-social">Assests</a></li>
        ...
        <div class="flex flex-row w-full gap-3">
                                ...
                                <td>
                                    <div class="hstack gap-2 text-[15px]">
                                        <a href="#youtube-video"
                                           class="glightbox border-0 mb-0 ti-btn ti-btn-icon ti-btn-soft-primary2"
                                        ...
                                        <a href="javascript:void(0);"
                                           class="btn-delete ti-btn ti-btn-soft-primary1 ti-btn-icon"><i
                                    ...
                                    <div class="hstack gap-2 text-[15px]">
                                        ...
                                        <a href="javascript:void(0);"
                                           class="ti-btn ti-btn-icon ti-btn-sm ti-btn-soft-primary3"><i
                                                class="ri-delete-bin-line" id="alert-parameter"></i></a>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="xxl:col-span-3 col-span-8 w-4/12 flex flex-col ">
                ...
                <div>
                    <li
                        class="!p-4 mb-3 border border-dashed border-defaultborder dark:border-defaultborder/10">

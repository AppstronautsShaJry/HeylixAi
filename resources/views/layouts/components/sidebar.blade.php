    ...
    <div class="main-sidebar font-defaultfont" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav flex flex-col w-64 h-full text-gray-400">
            <ul class="main-menu space-y-1 text-[16px]">
                ...
                <li
                    class="ml-2 h-12 nav-item group flex items-center px-4 py-3 rounded-md transition-colors hover:bg-[#27283f]"
                    data-url="/manage-brand"
                >
                    <a href="/manage-brand" class="flex items-center gap-3 w-full">
                        <div class="icon  group-hover:bg-primary text-gray-400 group-hover:text-white rounded-md p-2">
                ...
                <li
                    class="ml-2 h-12 nav-item group flex items-center px-4 py-3 rounded-md transition-colors hover:bg-[#27283f]"
                    data-url="/create-heylix"
                >
                    <a href="/create-heylix" class="flex items-center gap-3 w-full">
                        <div class="icon  group-hover:bg-primary text-gray-400 group-hover:text-white rounded-md p-2">
                ...
                <li
                    class="ml-2 h-12 nav-item group flex items-center px-4 py-3 rounded-md transition-colors hover:bg-[#27283f]"
                    data-url="/virtual-heylix"
                >
                    <a href="/virtual-heylix" class="flex items-center gap-3 w-full">
                        <div class="icon  group-hover:bg-primary text-gray-400 group-hover:text-white rounded-md p-2">
                            <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 29.95" class="w-5 h-5">
                                <defs>
                                    <style>
                ...
                <li
                    class="ml-2 h-12 nav-item group flex items-center px-4 py-3 rounded-md transition-colors hover:bg-[#27283f]"
                    data-url="/upgrade-index"
                >
                    <a href="/upgrade-index" class="flex items-center gap-3 w-full">
                        <div class="icon  group-hover:bg-primary text-gray-400 group-hover:text-white rounded-md p-2">
